class Player {
  ...
  setHitbox() {
    ...
    this.hitbox = {
      left: this.baseHitbox[0] + this.hitboxOffset[0],
      up: this.baseHitbox[1] + this.hitboxOffset[1],
      right: this.baseHitbox[2] / 3 + this.hitboxOffset[2],
      down: this.baseHitbox[3] + this.hitboxOffset[3],
    };
  }
  ...
  draw() {
        ...
        if (controller.t - levelNumber.time < 150) {
          ...
          c.strokeText(
            ...
            this.position.y +
              this.baseHitbox[3] -
              20 -
              (controller.t - levelNumber.time) / 2
          );
          c.fillStyle = "rgba(235, 235, 235, 0.9)";
          c.textAlign = "center";
          c.fillText(
    ...
    energyBar.style.width =
      (energyBarMaxWidth * this.energy) / this.maxEnergy + "px";
    expBar.style.width =
      (hpBarMaxWidth * this.exp) / this.levelExp[this.level] + "px";
    //Status data
  ...
  move() {
    ...
    if (!controller.mobileTouchStart) {
    ...
    //Up or Down
    if (controller.moveKeysDown.w && controller.moveKeysDown.s) {
      //Both pressed
    ...
    //Right or Left
    if (controller.moveKeysDown.d && controller.moveKeysDown.a) {
      //Both pressed
